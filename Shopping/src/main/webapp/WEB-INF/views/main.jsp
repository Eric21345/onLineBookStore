		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">文学 <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">流行</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">文化</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">生活</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">经管</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">科技</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">畅销</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>欢迎来到网上书店</h1>
					<p>网上书店是一个非常优秀的电子书店，你可以在这里买到你想要的书</p>
				</div>
